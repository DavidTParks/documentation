...
<Frame caption="Data refresh flow">
```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Your         │     │     Plaid       │     │   Tendrill      │
│   Brokerage    │────▶│   (Secure API)  │────▶│   Servers       │
│                │     │                 │     │                 │
│ • Holdings     │     │ • Encrypted     │     │ • Portfolio     │
│ • Transactions │     │ • Read-only     │     │   model         │
│ • Balances     │     │ • Daily sync    │     │ • Analysis      │
└─────────────────┘     └─────────────────┘     └─────────────────┘
                                                        │
                                                        ▼
                        ┌─────────────────┐     ┌─────────────────┐
                        │  Market Data    │     │   Your Phone    │
                        │   Providers     │────▶│   📱           │
                        │                 │     │                 │
                        │ • Live prices   │     │ • Alerts        │
                        │ • News feeds    │     │ • Insights      │
